...
class MCSetting {
    ...
    static func makeDemoList() -> [MCSetting] {
        let list = [
            MCSetting(title: "About", content: "Đây là đoạn text demo abount và không scroll được"),
            MCSetting(title: "Copyright", content: "Đây là đoạn text demo copyright, icon và âm thanh được clone từ noiseli.com"),
